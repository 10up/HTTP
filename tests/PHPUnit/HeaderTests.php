...
class HeaderTest extends TestCase {
	...
	public function test_instance() {
		...
		$property = new ReflectionProperty( 'TenUp\HTTP\Header', 'container' );
	...
	public function test_apply() {
		...
		foreach ( $parsed as $header ) {
			WP_Mock::wpFunction( 'TenUp\HTTP\header', array(
				'times' => 1,
				'args'  => $header,
			) );
		}
	...
	protected function getHeadersProperty() {
		$header = new ReflectionProperty( 'TenUp\HTTP\Header', 'headers' );
